...
Version  : 1.0.39
Release  : 48
URL      : https://cran.r-project.org/src/contrib/tree_1.0-39.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tree_1.0-39.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1522161556
